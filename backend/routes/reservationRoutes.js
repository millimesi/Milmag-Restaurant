...
router.post("/seeAvailableSpots", seeAvailableSpots); // GET http://localhost:8080/api/v1/reservation/seeAvailableSpots
router.post("/seeMyReservations", seeMyReservations); // GET http://localhost:8080/api/v1/reservation/seeMyReservations
